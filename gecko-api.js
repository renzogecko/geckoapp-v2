...
const GECKO_NUMERIC_FIELDS = {
    'gecko_materiales': ['stock','multiplicador','costoUSD','costoARS','costo','contenidoUnidad','multGremio','precioGremio','precioVenta','precioCorteMl','corteSpeed','cortePower','watts','densidad','lumenes'],

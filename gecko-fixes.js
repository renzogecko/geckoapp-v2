...
window.renderPresupuestos = async function () {
    ...
    tbody.innerHTML = filtrados.map(p => {
        ...
        <tr draggable="true" data-drag-key="${p.id}" class="hover:bg-gray-50/50 dark:hover:bg-gray-800/30 transition-colors" style="cursor:grab;">
            ...
            <td class="py-4 px-6 sticky left-0 z-10 bg-white dark:bg-darkCard">
            ...
            <td class="py-4 px-6 text-right sticky right-0 z-10 bg-white dark:bg-darkCard">
...
window._geckoRenderFijo = function () {
    ...
    bdClientes.forEach(c => {
        try {
            ...
            tr.innerHTML = `
            <td class="py-4 px-6 sticky left-0 z-10 bg-white dark:bg-darkCard" data-accion="ficha">
            ...
            <td class="py-4 px-6 text-center sticky right-0 z-10 bg-white dark:bg-darkCard">
